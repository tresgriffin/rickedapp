...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <link rel="apple-touch-startup-image" media="screen and (orientation: portrait)" href="/ricked-assets/splash/splash-1290x2796.png" />
        <link rel="apple-touch-startup-image" media="screen and (orientation: landscape)" href="/ricked-assets/splash/splash-1290x2796.png" />
      </head>
